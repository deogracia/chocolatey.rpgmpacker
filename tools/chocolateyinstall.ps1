...
$url        = 'https://github.com/erri120/rpgmpacker/releases/download/v1.5.4/RPGMPacker-Windows.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'rpgmpacker*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
